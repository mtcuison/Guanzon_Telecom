...
public class Import_McModel_Price implements ImportInstance {
    private static final String TAG = Import_McModel_Price.class.getSimpleName();
    ...
    public void SendImportRequest(Context context, final OnImportAssetListener listener) {
        ...
        if(connectionUtil.isDeviceConnected()){
            new HttpRequestUtil().sendRequest(CreditAppAPI.URL_IMPORT_MC_MODEL_PRICE, new HttpRequestUtil.onServerResponseListener() {
                @Override
                ...
                public JSONObject setData() {
                    try{
                        return new UpdateSet(mContext).getDataParameter(UpdateSet.LocalTables.Price);
                ...
                public void onResponse(JSONObject jsonResponse) {
                    ...
                    if(localData.InsertMcModelPrice(jsonResponse)) {
