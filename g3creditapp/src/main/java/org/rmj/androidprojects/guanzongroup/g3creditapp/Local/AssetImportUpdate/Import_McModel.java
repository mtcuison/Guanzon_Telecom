...
public class Import_McModel implements ImportInstance {
    private static final String TAG = Import_McModel.class.getSimpleName();
    ...
    public void SendImportRequest(Context context, final OnImportAssetListener listener) {
        ...
        if(connectionUtil.isDeviceConnected()){
            new HttpRequestUtil().sendRequest(CreditAppAPI.URL_IMPORT_MC_MODEL, new HttpRequestUtil.onServerResponseListener() {
                @Override
                ...
                public JSONObject setData() {
                    try{
                        return new UpdateSet(mContext).getDataParameter(UpdateSet.LocalTables.Model);
                ...
                public void onResponse(JSONObject jsonResponse) {
                    ...
                    if(localData.InsertMcModel(jsonResponse)) {
