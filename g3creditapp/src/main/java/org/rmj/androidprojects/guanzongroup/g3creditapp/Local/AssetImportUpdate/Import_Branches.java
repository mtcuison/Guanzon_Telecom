...
public class Import_Branches implements ImportInstance {
    private static final String TAG = Import_Branches.class.getSimpleName();
    ...
    public void SendImportRequest(Context context, final OnImportAssetListener listener) {
        ...
        if(connectionUtil.isDeviceConnected()){
            new HttpRequestUtil().sendRequest(CreditAppAPI.URL_IMPORT_BRANCHES, new HttpRequestUtil.onServerResponseListener() {
                @Override
                ...
                public JSONObject setData() {
                    try{
                        return new UpdateSet(mContext).getDataParameter(UpdateSet.LocalTables.Brand);
                ...
                public void onResponse(JSONObject jsonResponse) {
                    ...
                    if(localData.InsertBranches(jsonResponse)) {
