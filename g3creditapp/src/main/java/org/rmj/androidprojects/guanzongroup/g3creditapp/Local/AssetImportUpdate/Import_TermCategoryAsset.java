...
public class Import_TermCategoryAsset implements ImportInstance {
    private static final String TAG = Import_TermCategoryAsset.class.getSimpleName();
    ...
    public void SendImportRequest(Context context, final OnImportAssetListener listener) {
        ...
        if(connectionUtil.isDeviceConnected()){
            new HttpRequestUtil().sendRequest(CreditAppAPI.URL_IMPORT_TERM_CATEGORY, new HttpRequestUtil.onServerResponseListener() {
                @Override
                ...
                public JSONObject setData() {
                    try{
                        return new UpdateSet(mContext).getDataParameter(UpdateSet.LocalTables.Term);
                ...
                public void onResponse(JSONObject jsonResponse) {
                    ...
                    if(localData.InsertTermCategory(jsonResponse)) {
