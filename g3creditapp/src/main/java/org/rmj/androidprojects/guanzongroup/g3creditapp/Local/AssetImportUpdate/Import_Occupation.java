...
public class Import_Occupation implements ImportInstance{
    private static final String TAG = Import_Occupation.class.getSimpleName();
    ...
    public void SendImportRequest(Context context, final OnImportAssetListener listener) {
        ...
        if(connectionUtil.isDeviceConnected()){
            new HttpRequestUtil().sendRequest(CreditAppAPI.URL_IMPORT_OCCUPATIONS, new HttpRequestUtil.onServerResponseListener() {
                @Override
                ...
                public JSONObject setData() {
                    try{
                        return new UpdateSet(mContext).getDataParameter(UpdateSet.LocalTables.Occupation);
                ...
                public void onResponse(JSONObject jsonResponse) {
                    ...
                    if(localData.InsertOccupation(jsonResponse)) {
