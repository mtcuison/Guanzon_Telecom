...
public class Import_CountryAsset implements ImportInstance {
    private static final String TAG = Import_CountryAsset.class.getSimpleName();
    ...
    public void SendImportRequest(Context context, final OnImportAssetListener listener) {
        ...
        if (connectionUtil.isDeviceConnected()) {
            new HttpRequestUtil().sendRequest(CreditAppAPI.URL_IMPORT_COUNTRY, new HttpRequestUtil.onServerResponseListener() {
                @Override
                ...
                public JSONObject setData() {
                    try {
                        ...
                        return new UpdateSet(mContext).getDataParameter(UpdateSet.LocalTables.Country);
                ...
                public void onResponse(JSONObject jsonResponse) {
                    ...
                    if(localData.InsertCountry(jsonResponse)) {
